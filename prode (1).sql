...
--
-- Servidor: localhost
-- Tiempo de generación: 13-05-2022 a las 21:25:37
...
CREATE TABLE `usuario` (
  ...
  `funcion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
...
INSERT INTO `usuario` (`id`, `nombre`, `estado`, `funcion`) VALUES
(111, 'sebastian', 'inactivo', 'profesor'),
(123, 'maria ', 'inactivo', 'estudiante');
